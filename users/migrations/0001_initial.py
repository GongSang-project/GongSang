    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_time', models.CharField(blank=True, choices=[('A', '🌤️ 아침형'), ('B', '🌙 저녁형')], max_length=1, null=True)),
                ('conversation_style', models.CharField(blank=True, choices=[('A', '🤫 필요한 대화만'), ('B', '🗣️ 자주 대화')], max_length=1, null=True)),
                ('important_points', models.TextField(blank=True, null=True, verbose_name='생활 공간에서 가장 중요하게 생각하는 점')),
                ...
                ('living_type', models.CharField(blank=True, choices=[('alone_female_senior', '혼자'), ('senior_couple', '시니어 부부'), ('grandchild', '손자')], max_length=30, null=True, verbose_name='동거 형태')),
